...
export default function ConfirmDialog({ 
  ...
  // Determine button classes based on confirmColor
  const confirmButtonClasses = `cursor-pointer ${
    confirmColor === "red" 
      ? "bg-red-600 hover:bg-red-700 focus:ring-red-500" 
      : "bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500"
  } text-white font-medium rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-offset-2`;
